...
/*
	Este pacote tem por finalidade retornar uma estrutura contendo um map de erros usados na aplicação
...
type ValidationErrors struct {
	FieldName string
	Erros     map[string]ValidationError `json:"validationErrors"` // Observação: atenção as tags
}
...
// Função abaixo deve ser usada em pacote diferente ...
...
// Refatorar
func GetValidationError(fieldName, errorCode string, ) *ValidationCodeErrors {
	LoadValidationErrors()
