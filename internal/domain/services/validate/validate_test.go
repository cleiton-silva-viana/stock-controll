...
func TestIsBlankWithError(t *testing.T) {
	...
	for _, tt := range testsCases {
		t.Run(tt.description, func(t *testing.T) {
			...
			// Act
			err := New("field", tt.value, IsBlank())
...
func TestIsBeforeThanNoError(t *testing.T) {
	...
	// Act
	err := New("birth_date", birthDate, IsBeforeThan(minDate))
...
func TestIsBeforeThanWithError(t *testing.T) {
	...
	// Act
	err := New("current_date", birthDate, IsBeforeThan(minDate))
...
func TestIsAfterThanNoError(t *testing.T) {
	...
	// Act
	err := New("current_date", birthDate, IsAfterThan(maxDate))
